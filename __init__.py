...
_PLUGIN_NAME = 'Shaobkj-Enhanced Toolset'
_SAFE_PLUGIN_NAME = 'Shaobkj-Enhanced Toolset'
...
MODULE_NAMES = [
    "florence2_nodes",
    "tiling",
    "Shaobkj_Florence2_Prompt",
    "custom_image_crop",
    "qwen_prompt_rewriter",
]
...
for module_name in MODULE_NAMES:
    ...
    if isinstance(display_name_mappings, dict):
